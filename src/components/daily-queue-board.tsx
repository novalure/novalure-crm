...
import type { CalendarEvent, Contact, Lead, Project, Task } from "@/lib/crm-types";
import { formatDateTime, formatNumber, getCrmTaskDueLabel, getCrmTaskPriorityLabel, type LanguageCode } from "@/lib/i18n";

type DailyQueueSection = "leadInbox" | "tasks" | "calendar";
...
const text = {
  de: {
    ...
    openCalendar: "Termine oeffnen",
    openLeadInbox: "Lead-Zentrale oeffnen",
    openTasks: "Aufgaben oeffnen",
