...
const text = {
  de: {
    ...
    deposit: "Anzahlung",
    description: "Gefilterte Ansicht fuer reservierte Einheiten mit Fristen, Warnungen und Status.",
    empty: "Keine aktiven Reservierungen im aktuellen Projektfilter.",
    milestone: "Vertragsstand",
    nextAction: "Naechster Schritt",
    noBuyer: "Kein Kontakt",
    noDeal: "Kein Deal",
    noNextAction: "Kein naechster Schritt hinterlegt",
