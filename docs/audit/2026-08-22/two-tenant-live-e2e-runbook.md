...
Auf Preview-Deployment `dpl_BcDq1dTKfxYuSpDYztPt2qG4NKu2` mit Source-SHA `2a765ebec250316fe0802155a2c591567438dda9` bestand der Harness den Modus `preflight` mit 94/94 Ergebnissen und 50 Requests. Belegt sind beide QA-Tenant-Ziele, App-Rolle/RLS/Ledger-Projektion, 11/11 Migrationschecksummen, 19/19 validierte Tenant-Constraints ohne Anti-Join-Verstoß, zehn authentifizierte Rollen-/Reset-Sessions, acht korrekt verweigerte Cross-Tenant-Core-Reads, zwei anonyme 401-Grenzen, zwei öffentliche 200-Seiten ohne fremde Workspace-ID und zehn akzeptierte Logout-Aufrufe mit Status 303. Eine Post-Logout-Invalidierung wurde nicht geprüft. Die Requestliste enthält keine CRM-Mutationsroute; Auth-/Session-/Audit-Sicherheitswrites können dennoch erfolgt sein. `cleanup=[]` bedeutet deshalb ausschließlich, dass kein Geschäftswritelauf begonnen wurde, nicht dass Cleanup bewiesen wäre.

Preflight-Artefakt: `artifacts/qa/preview-2a765eb-preflight-20260823/preflight-two-tenant-e2e.json`; kanonischer SHA-256: `f000d7b7ba89ad1051423872a7c98de179dffbd020090c754adbb8d886f23062`. Barrierenartefakt: `artifacts/qa/preview-lock-barrier-pending-sha-20260823/lock-order-evidence.json`, SHA-256 `81af6d6e2ae8580d41e920bc71330265a85b750b17a18c19f7247f6dd3299666`; Postcondition SHA-256 `a61e3013db0d2328cc0e03ef518b8f3f652f3fbc390eeb0177219a145f54cca5`. Capability-Endpunkt, atomare Runtime-Batchregistrierung über HTTP, CRUD, Reset/Cleanup, Post-Logout-Invalidierung und vollständige MFA-/Ablauf-/Rate-Limit-Matrix sind weiterhin nicht belegt. Wegen des nachfolgenden Lock-/ACL-Fixes muss der Preflight auf dem nächsten SHA-identischen Kandidaten wiederholt werden.
...
Reale QA-Wurzeln, MFA-Fixtures, leere Batches, Migrationen und der atomare Runtime-Vertrag sind vorhanden. Der read-only Auth-/Tenant-/DB-Preflight auf Preview-Commit `2a765eb` bestand 94/94 Ergebnisse und 50 Requests; der danach ausgeführte direkte PostgreSQL-Barrieredrill bestand 4/4 mit Null-Rückstand. Der Drill deckte zugleich den unnötigen Batch-Row-Lock auf, der im lokalen Kandidaten behoben wurde. Deshalb bleiben das neue SHA-identische Preview-Deployment, dessen erneut deployment-spezifisch freizugebender Zugang, der wiederholte Preflight, Capability-Proof sowie der echte Matrix-/Cleanup-Lauf offen; Post-Logout-Invalidierung und die vollständige Challenge-Matrix sind ebenfalls nicht bewiesen. Das Gesamtgate bleibt rot.
