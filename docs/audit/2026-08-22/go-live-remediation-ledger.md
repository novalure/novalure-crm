...
- Die zentrale, unveränderliche Launch-Scope-Policy (`2026-08-22.12`, `PENDING_SIGNATURE`) enthält 35 Regeln und erzwingt unbekannte bzw. nicht freigegebene Surfaces fail-closed. Sie umfasst unter anderem Customer-Communication-Providerwrites, Funnel-Token-Cutover/-Rotation, Public-Form-Submission/-Proof-Refresh, Calendar-Mutationen, Bot-Channel-Inbound, die spanische Public-Surface, Reservation-Relationship-Sync, QA und Systemdiagnostik; sie ist noch keine signierte Vollmatrix aller Produktflächen.
...
Der aktuelle Stand enthält zusätzlich Policy 2026-08-22.12, monotone Bot-/Providerkontrollen, durable Inbound-Webhook-Verarbeitung, Funnel-Revision-CAS/Secret-Sanitization sowie Deal-/QA-Batch-Ownership-Härtung. Der unabhängige statische Review des lokalen Mikrosekunden-/Task-CAS-Diffs weist `0 P0/0 P1` aus; dies ist ausdrücklich kein finaler Runtimebefund. Der jüngste deployte Execute stoppte auf der vorherigen SHA beim Kontakt-PATCH mit 409, und die externen sowie E2E-Releasegates aus Abschnitt 9 bleiben offen.
...
| Produktionsmigrationen der Kandidatenkette 057, 060 und 068–079; 061 bleibt separater App-Rollen-Cutover, 062/065 benötigen eine ausdrückliche Aufnahme- oder dokumentierte Ausschlussentscheidung | Backup, Dry-run, geprüfter Rollback, erfolgreicher Restore-Drill, DBA-/Releasefreigabe |
...
## 14. Datiertes Addendum 23.08.2026

Die Abschnitte 1–13 dokumentieren den jeweils zum damaligen Prüfschritt beobachteten Stand und werden nicht rückwirkend als schon damals grün umgedeutet. Nach separater ausdrücklicher Freigabe wurden Migration 078 und 079 ausschließlich auf `weathered-term-98273025 / br-lucky-heart-alrm9dlw` angewandt. Der Ledger endet dort checksummengenau bei 079; 061, 062 und 065 sind weiterhin nicht vorhanden. Production wurde nicht verändert. Die gehashte Migrations-Evidenz liegt unter `artifacts/qa/preview-2d29252-migrations-078-079-20260823/`, ist aber weiterhin untracked und nicht signiert. Dieser Nachtrag schließt ausschließlich diesen Preview-Migrationspunkt; die Gesamtentscheidung bleibt `NO-GO`.
